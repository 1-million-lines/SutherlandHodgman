...
public class SutherlandHodgman extends JFrame {
	...
	private final SutherlandHodgmanPanel panel;
	...
	public SutherlandHodgman() {
		...
		setTitle("Sutherland - Hodgman");
		pack();
		setLocationRelativeTo(null);
	}

	public static void main(final String... args) {
		final JFrame frame = new SutherlandHodgman();
...
class SutherlandHodgmanPanel extends JPanel {
	private List<double[]> subject, clipper, result;
